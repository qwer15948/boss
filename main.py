...
party_routes = {
    1: [
        ("구루타", "+0:00"), ("카샤파", "+1:15"), ("타르탄", "+1:43"), 
        ("바르시엔", "+2:13"), ("악시오스", "+3:09"), ("노블루드", "+4:14")
    ],
    2: [
        ("가르투아", "+0:04"), ("카샤파", "+1:15"), ("타르탄", "+1:43"), 
        ("카루카", "+2:24"), ("악시오스", "+3:09"), ("비슈베다", "+5:22")
    ],
    3: [
        ("쉬라크", "+0:23"), ("카샤파", "+1:15"), ("타르탄", "+1:43"), 
        ("카루카", "+2:24"), ("악시오스", "+3:09"), ("비슈베다", "+5:22")
    ],
    4: [
        ("가르투아", "+0:04"), ("카샤파", "+1:15"), ("타르탄", "+1:43"), 
        ("카루카", "+2:24"), ("악시오스", "+3:09"), ("노블루드", "+4:14")
    ]
}
